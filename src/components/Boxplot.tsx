...
export function Boxplot({dataMap, geneName, geneDescription, xPoints}:
  ...
  xPoints: Number[]
    ...
    return (
      <div className="graph-container">
        <Plot
          data= {dataMap}
          layout={ {width: 1000, height: 600, title: { text: geneName, font: {size: 24, color:'black'}}, margin: { t: 100, b: 100}, 
            xaxis: {
              title: {
                text: "Hour",
                font: {
          ...
          config = {{
            toImageButtonOptions: {
              ...
              filename: geneName+'_boxplot_image',
              height: 500,
              width: 1000,
